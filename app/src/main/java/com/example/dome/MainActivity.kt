...
// ... Tu código anterior ...
    ...
    private fun agregarNuevaTarea() {
        ...
        if (tarea.isNotEmpty()) {
            ...
            nuevaTareaEditText.textSize = 22f
            ...
            nuevaCheckBox.setOnCheckedChangeListener { _, isChecked ->
                if (isChecked) {
                    eliminarTarea(nuevaTareaLayout)
                }
            }
    ...
    private fun eliminarTarea(layout: LinearLayout) {
        tasksContainer.removeView(layout)
    }
